...
<body class="bg-[#F2F2F2] overflow-auto mb-[200px]">
    ...
    <div class="flex items-center px-6 py-2 bg-[#F3BF01] h-32">
        ...
        <h1 class="flex-1 text-center text-xl font-semibold text-[#181C14]">Settings</h1>
    </div>

    <div class="mt-10 px-4">
        <div class="bg-white rounded-[20px] p-4">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold text-[#181C14]">Legal Notice</h2>
            </div>
            <a href="boss-edit.php">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-sm text-[#181C14]">Privacy Policy</p>
                    </div>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#181C14">
            ...
            <a href="address.php">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-sm text-[#181C14]">Shipping Policy</p>
                    </div>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#181C14">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
            ...
            <a href="password.php">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-sm text-[#181C14]">Return and Refund Policy</p>
                    </div>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#181C14">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
            ...
            <a href="sales.html">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-sm text-[#181C14]">Terms and Condition</p>
                    </div>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#181C14">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
            ...
            <a href="help.php">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-sm text-[#181C14]">Help</p>
                    </div>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#181C14">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
            ...
            <a href="feedback.php">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-sm text-[#181C14]">Feedback</p>
                    </div>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#181C14">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
            ...
            <a href="report-bug.php">
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-sm text-[#181C14]">Report Bug / Error</p>
                    </div>
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#181C14">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
