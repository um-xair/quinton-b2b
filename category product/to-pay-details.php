...
<head>
    ...
    <title>Order Details-To Pay</title>
...
<body class="bg-[#F2F2F2] overflow-auto mb-[200px]">
        ...
        <div class="bg-white rounded-[20px]">
            <div class="flex items-center justify-between bg-[#F3BF01] p-4 rounded-t-[20px]">
                <div class="flex items-center">
                    <label for="defaultAddress" class="text-md">To Pay in: 30 days ( 30 December 2024 )</label>
                </div>
            </div>
            <div class="mt-4 p-4">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-[#181C14] text-md">Pay by Credit Card</p>
                    </div>
                    <button class="w-8 h-8 bg-black text-white rounded-full hover:bg-gray-800 flex items-center justify-center">
    ...
    <div class="fixed bottom-32 left-4 right-4 bg-[#F3BF01] py-4 px-6 rounded-full z-[999]">
        <div class="flex justify-between items-center text-[#181C14] font-medium">
            <span>Total Payment:</span>
            <span class="text-xl font-bold">RM2998</span>
        </div>
    </div>
    ...
    <div class="fixed bottom-10 left-4 right-4 bg-[#F3BF01] py-4 px-4 rounded-full z-[999]">
        <div class="flex justify-around gap-2">
            ...
            <button class="w-1/2 bg-[#181C14] text-white py-3 rounded-full">Pay Now</button>
        </div>
    </div>
