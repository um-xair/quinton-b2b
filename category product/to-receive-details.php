...
<head>
    ...
    <title>Order Details-To Receive</title>
...
<body class="bg-[#F2F2F2] overflow-auto mb-[200px]">
        ...
        <div class="bg-white rounded-[20px]">
            <div class="flex items-center justify-between bg-[#F3BF01] p-4 rounded-t-[20px]">
                <div class="flex items-center">
                    <label for="defaultAddress" class="text-md">Tracking the order</label>
                </div>
            </div>
            <div class="mt-4 px-4 pb-6">
                <p class="font-bold text-[#181C14] text-lg mb-1">Departed from sorting center</p>
                <p class="text-[#181C14] text-sm">Left the CDC SENAI 315 sorting center in KULAI</p>
            </div>
        </div>
    </div>
    ...
    <div class="fixed bottom-10 left-4 right-4 bg-[#F3BF01] py-4 px-4 rounded-full z-[999]">
        <div class="flex justify-end gap-2">
            <button class="w-1/2 bg-[#181C14] text-white py-3 rounded-full">Track Order</button>
        </div>
    </div>
