...
<head>
    ...
    <title>Order Details-To Cancel</title>
...
<body class="bg-[#F2F2F2] overflow-auto mb-[200px]">
    ...
    <div class="flex items-center px-6 py-2 bg-[#F3BF01] h-32">
        ...
        <h1 class="flex-1 text-center text-xl font-semibold text-[#181C14]">Cancellation Details</h1>
    </div>
        ...
        <div class="bg-white rounded-[20px]">
            <div class="flex items-center justify-between bg-[#F3BF01] p-4 rounded-t-[20px]">
                <div class="flex items-center">
                    <label for="defaultAddress" class="text-md">Cancellation Details</label>
                </div>
            </div>
            <div class="mt-4 px-4 pb-4">
                <div class="flex justify-between items-center">
                    <p class="text-[#181C14] text-md">Requested by</p>
                    <p class="text-[#181C14] text-md">Buyer</p>
                </div>
                <div class="flex justify-between items-center mt-2">
                    <p class="text-[#181C14] text-md">Requested at</p>
                    <p class="text-[#181C14] text-md">12-12-2024 11:18AM</p>
                </div>
                <div class="flex justify-between items-center mt-2">
                    <p class="text-[#181C14] text-md">Reason</p>
                    <p class="text-[#181C14] text-md">don’t want to buy anymore</p>
                </div>
                <div class="flex justify-between items-center mt-2">
                    <p class="text-[#181C14] text-md">Payment Method</p>
                    <p class="text-[#181C14] text-md">Unpaid</p>
                </div>
            </div>
    ...
    <div class="mt-6 px-4">
        <div class="bg-white rounded-[20px]">
            <div class="flex items-center justify-between bg-[#F3BF01] p-4 rounded-t-[20px]">
                <div class="flex items-center">
                    <label for="defaultAddress" class="text-md">Refund Details</label>
                </div>
            </div>
            <div class="mt-4 px-4 pb-4">
                <div class="flex justify-between items-center">
                    <p class="text-[#181C14] text-md">Refund amount</p>
                    <p class="text-[#181C14] text-md">RM 1000.00</p>
                </div>
                <div class="flex justify-between items-center mt-2">
                    <p class="text-[#181C14] text-md">Refund to</p>
                    <p class="text-[#181C14] text-md">Buyer account</p>
                </div>
                <div class="flex justify-between items-center mt-2">
                    <p class="text-[#181C14] text-md">Requested by</p>
                    <p class="text-[#181C14] text-md">Buyer</p>
    ...
    <div class="fixed bottom-10 left-4 right-4 bg-[#F3BF01] py-4 px-4 rounded-full z-[999]">
        <div class="flex justify-end gap-2">
            <button class="w-1/2 bg-[#181C14] text-white py-3 rounded-full">Buy Again</button>
        </div>
    </div>
