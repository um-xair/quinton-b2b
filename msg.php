...
<body class="bg-white h-screen flex items-center justify-center text-center px-6">
    ...
    <div id="splash-screen" class="bg-white p-8 w-full max-w-md opacity-0 transition-opacity duration-1000">
        ...
        <h1 class="text-3xl font-bold text-[#181C14] mt-10 text-center">Success!</h1>
        <p class="text-lsm text-[#181C14] mb-10 text-center">You've logged in</p>
    </div>
    ...
    <script>
        window.onload = function() {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    window.location.href = 'http://localhost/quinton-b2b/home.php'; 
                }, 500); 
            }, 3000);
        }
    </script>
