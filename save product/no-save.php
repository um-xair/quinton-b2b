...
<body class="bg-white overflow-auto mb-[200px]">
    ...
    <div class="flex items-center px-6 py-2 bg-[#F3BF01] h-32">
        ...
        <h1 class="flex-1 text-center text-xl font-semibold text-[#181C14]">Save Prdouct</h1>
    </div>
    ...
    <div class="mt-10 px-4 flex flex-col items-center justify-center">
        ...
        <p class="text-[#181C14] text-center text-lg">Oops! You have no saved products yet.</p>
    </div>
