...
<body class="bg-[#F2F2F2] overflow-auto mb-[200px]">
            ...
            <div class="flex items-center justify-between bg-[#F3BF01] p-4 rounded-t-[20px]">
                ...
                <div class="flex items-center space-x-4">
                    <a href="add-address.php">
                        <button class="p-2 bg-black text-white rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
                                <path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/>
                            </svg>
                        </button>
                    </a>
                    <a href="delete-msg.html">
    ...
    <div class="fixed bottom-10 left-0 w-full px-6 z-[999]">
        <a href="add-address.php" class="w-full inline-block bg-[#181C14] px-4 py-4 rounded-full text-white font-bold text-center">
            Add New
        </a>
    </div>
